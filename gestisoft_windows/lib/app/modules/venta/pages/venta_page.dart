                                        ...
                                        onPressed: () {
                                          if (ventaController.currentRecord
                                            ...
                                            Alert.show(
                                                ...
                                                type: 1);
                                            return;
                                          } else if (formVentaKey.currentState!
                                              .validate()) {
                                            ventaController
                                            ...
                                            ventaController
                                                ...
                                                ventaController.vehiculoET.text;
                                            ventaController
                                                  ...
                                                  onSubmited: (value) {
                                                    if (ventaController
                                                      ...
                                                      Alert.show(
                                                        context: context,
                                                        message:
                                                            "Complete los campos de cantidad y precio del item",
                                                        type: 1,
                                                      );
                                                    } else {
                                                      ventaController
